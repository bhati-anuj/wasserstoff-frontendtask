  ...
  return (
    <>
      ...
      >
        <CarouselContent>
          <CarouselItem >
            <Image src={Event1} alt="event image" width={"auto"} height={"auto"} className="aspect-square"/>
          </CarouselItem>
          <CarouselItem>
            <Image src={Event2} alt="event image" width={600} height={400} className="aspect-square" />
          </CarouselItem>
          <CarouselItem>
